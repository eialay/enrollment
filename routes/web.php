...
Route::post('/enrollment/queue', [EnrollmentController::class, 'getQueueNumber'])->middleware('auth')->name('enrollment.queue');
Route::get('/enrollment/queue-list', [EnrollmentController::class, 'queueList'])->middleware('auth')->name('enrollment.queueList');
Route::delete('/enrollment/queue/{id}', [EnrollmentController::class, 'deleteQueue'])->middleware('auth')->name('enrollment.queueDelete');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/student/update/{id}', [StudentProfileController::class, 'update'])->name('students.update');
});
